...
<script>
    // System Architecture - All mathematical processing nodes declared first to guarantee clean compilation hoisting
    let recorder = null;
    let chunks = [];
    ...
    async function dispatchPayload(bpm, lowPercent, highPercent, midEnergy) {
        ...
        const payload = {
            ...
            instruments: "Layered polyphonic synthesizers, driving 808 acoustic kick drum, crisp hi-hats, deep sub-bass line, analog console warmth"
        };
        ...
        try {
            ...
            statusBadge.innerText = "Status: Failed linking to server processing gate.";
            console.error(err);
        }
    }
    ...
    // Action Event Listeners - Registered safely *after* target execution functions are bound to scope
    audioFileInput.addEventListener('change', async (e) => {
        ...
        // Force state wake verification to bypass iOS/Android hardware sleep lockouts
        ...
        try {
            ...
            statusBadge.innerText = "Status: Processing native source. Running fallback engine...";
    ...
    recordBtn.addEventListener('click', async () => {
        if (!recorder || recorder.state === 'inactive') {
            ...
            try {
                ...
                statusBadge.innerText = "Status: Sandbox Block. Please use 'Analyze File' option.";
            }
        } else {
            recorder.stop();
